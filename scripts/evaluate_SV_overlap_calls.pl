...
=head1 SYNOPSIS
  ...
  evaluate_SV_overlap_calls.pl <option> # the input directory (the working directory by default) must contain vcf files to be tested, each of which starts with tool name (e.g., Manta.sample1.vcf).
